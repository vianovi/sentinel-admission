                ...
                <div className="relative" ref={userMenuRef}>
                    <button
                        ...
                        className="flex items-center gap-2.5 pl-1 pr-2 py-1
                                   ...
                                   transition group"
                    >
                        {/* Avatar — foto kalau ada, fallback initials */}
                        <div className="w-8 h-8 rounded-xl overflow-hidden bg-gold flex items-center justify-center shrink-0">
                            {user.avatar_url ? (
                                <img
                                    src={user.avatar_url}
                                    alt={user.name}
                                ...
                                <span className="text-navy text-xs font-bold">{user.initials}</span>
                            )}
                        </div>
